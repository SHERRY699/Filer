...
import pic from "../../../public/audit/pic.jpg";
    ...
    <section className="selection:bg-[#bb5644] font-sans">
      ...
      >
        <Herocard
          title=" 
            Audit."
          desc=" Audit verifies correctness, rule compliance, and enhances processes. It confirms proper functioning and pinpoints areas for improvement or correction at"
          buttontitle="Audit $45*"
          width="600"
          heigth="350"
        />
      </div>
      ...
      <div className="w-full h-full flex flex-col items-center justify-start mt-4 gap-4">
        ...
        <div className="card w-full h-full grid grid-cols-1 sm:grid-cols-3 place-items-center place-content-start sm:flex sm:justify-center md:px-4      pt-4 gap-4 ">
          <TrademarkRegcard
            ...
            desc=" Clearly outline the purpose and goals of the audit. Identify the specific areas or processes you want to assess."
          />

          <TrademarkRegcard
            image={card1}
            title="2. Gather Information"
            desc="Collect relevant data, documents, and information related to the chosen areas. Ensure you have all the necessary materials for a comprehensive review"
          />

          <TrademarkRegcard
            image={card2}
            title="3. Document Findings and Recommendations"
            desc="Evaluate the gathered information, document any discrepancies or areas for improvement, and provide clear recommendations. Summarize your findings in a concise report for easy communication."
          />
        </div>
      </div>
          ...
          <div className="w-full h-full flex items-center justify-center md:justify-start">
            <div className="content font-sans w-9/12 h-full  flex flex-col gap-4 sm:items-center sm:justify-center lg:items-start ">
              <h2 className="text-2xl font-bold mt-4 leading-10 px-10 sm:text-4xl  lg:text-[42px] 3xl:leading-[60px]">
                Why use a Filer.me for your Statement of Use Extension?
              </h2>
              <p className="text-sm px-10 3xl:leading-7 lg:text-[16px] text-secondary">
                A Filer.me streamlines the Statement of Use extension process,
                saving time and effort by automating necessary steps002E It
                helps ensure the submission is accurate, reducing the risk of
                errors in providing the required information for the extension.
                Helps you stay compliant with regulations, guiding you through
                the extension process following trademark laws.Helps prevent
                errors, ensuring your extension submission is accurate and
                compliant with legal requirements. It saves time by automating
                tasks, allowing for quicker and more efficient completion of the
                Statement of Use extension process.
              </p>
            </div>
          </div>
        </div>
