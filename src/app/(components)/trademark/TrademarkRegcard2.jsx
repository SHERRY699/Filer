...
function TrademarkRegcard(props) {
  ...
  return (
    <div className='w-9/12 sm:w-[220px] sm:h-[220px] md:w-[300px] md:h-[300px] lg:w-[400px] lg:h-[200px]  h-[150px] rounded-2xl flex flex-col pl-4 items-start gap-6 pt-4 bg-white border-2 border-primary'>
